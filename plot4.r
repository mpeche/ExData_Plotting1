...
##Global Active power
plot(hh$Time,hh$Global_active_power,type="l", ylab="Global Active Power", xlab="")

##Voltage
plot(hh$Time,hh$Voltage,type="l", ylab="Voltage", xlab="datetime")

##Energy sub metering
plot(hh$Time,hh$Sub_metering_1,type="n", ylab="Energy sub metering", xlab="")
...
plot(hh$Time,hh$Global_reactive_power,type="l", ylab="Global_reactive_power", xlab="datetime")
